...
enum ImageFormat 
{
	...
	IMAGE_FORMAT_ASTC4x4_HDR,

	// 2D ASTC block sizes (LDR)
	IMAGE_FORMAT_ASTC5x4,
	IMAGE_FORMAT_ASTC5x5,
	IMAGE_FORMAT_ASTC6x5,
	IMAGE_FORMAT_ASTC6x6,
	IMAGE_FORMAT_ASTC8x5,
	IMAGE_FORMAT_ASTC8x6,
	IMAGE_FORMAT_ASTC8x8,
	IMAGE_FORMAT_ASTC10x5,
	IMAGE_FORMAT_ASTC10x6,
	IMAGE_FORMAT_ASTC10x8,
	IMAGE_FORMAT_ASTC10x10,
	IMAGE_FORMAT_ASTC12x10,
	IMAGE_FORMAT_ASTC12x12,

	// 3D ASTC block sizes (LDR, OES profile)
	IMAGE_FORMAT_ASTC3x3x3,
	IMAGE_FORMAT_ASTC4x3x3,
	IMAGE_FORMAT_ASTC4x4x3,
	IMAGE_FORMAT_ASTC4x4x4,
	IMAGE_FORMAT_ASTC5x4x4,
	IMAGE_FORMAT_ASTC5x5x4,
	IMAGE_FORMAT_ASTC5x5x5,
	IMAGE_FORMAT_ASTC6x5x5,
	IMAGE_FORMAT_ASTC6x6x5,
	IMAGE_FORMAT_ASTC6x6x6,

	// 2D ASTC block sizes (HDR)
	IMAGE_FORMAT_ASTC5x4_HDR,
	IMAGE_FORMAT_ASTC5x5_HDR,
	IMAGE_FORMAT_ASTC6x5_HDR,
	IMAGE_FORMAT_ASTC6x6_HDR,
	IMAGE_FORMAT_ASTC8x5_HDR,
	IMAGE_FORMAT_ASTC8x6_HDR,
	IMAGE_FORMAT_ASTC8x8_HDR,
	IMAGE_FORMAT_ASTC10x5_HDR,
	IMAGE_FORMAT_ASTC10x6_HDR,
	IMAGE_FORMAT_ASTC10x8_HDR,
	IMAGE_FORMAT_ASTC10x10_HDR,
	IMAGE_FORMAT_ASTC12x10_HDR,
	IMAGE_FORMAT_ASTC12x12_HDR,

	// 3D ASTC block sizes (HDR)
	IMAGE_FORMAT_ASTC3x3x3_HDR,
	IMAGE_FORMAT_ASTC4x3x3_HDR,
	IMAGE_FORMAT_ASTC4x4x3_HDR,
	IMAGE_FORMAT_ASTC4x4x4_HDR,
	IMAGE_FORMAT_ASTC5x4x4_HDR,
	IMAGE_FORMAT_ASTC5x5x4_HDR,
	IMAGE_FORMAT_ASTC5x5x5_HDR,
	IMAGE_FORMAT_ASTC6x5x5_HDR,
	IMAGE_FORMAT_ASTC6x6x5_HDR,
	IMAGE_FORMAT_ASTC6x6x6_HDR,
...
typedef enum _D3DFORMAT
	{
		...
		// ASTC compressed formats for Mali GPUs (all blocks are 16 bytes / 128 bits)
		D3DFMT_ASTC4x4			= 0x34545341,	// MAKEFOURCC('A', 'S', 'T', '4')
		D3DFMT_ASTC4x4_HDR		= 0x34485341,	// MAKEFOURCC('A', 'S', 'H', '4')

		// 2D ASTC LDR block sizes
		D3DFMT_ASTC5x4			= 0x34545342,
		D3DFMT_ASTC5x5			= 0x34545343,
		D3DFMT_ASTC6x5			= 0x34545344,
		D3DFMT_ASTC6x6			= 0x34545345,
		D3DFMT_ASTC8x5			= 0x34545346,
		D3DFMT_ASTC8x6			= 0x34545347,
		D3DFMT_ASTC8x8			= 0x34545348,
		D3DFMT_ASTC10x5			= 0x34545349,
		D3DFMT_ASTC10x6			= 0x3454534A,
		D3DFMT_ASTC10x8			= 0x3454534B,
		D3DFMT_ASTC10x10		= 0x3454534C,
		D3DFMT_ASTC12x10		= 0x3454534D,
		D3DFMT_ASTC12x12		= 0x3454534E,

		// 3D ASTC LDR block sizes (OES profile)
		D3DFMT_ASTC3x3x3		= 0x34545350,
		D3DFMT_ASTC4x3x3		= 0x34545351,
		D3DFMT_ASTC4x4x3		= 0x34545352,
		D3DFMT_ASTC4x4x4		= 0x34545353,
		D3DFMT_ASTC5x4x4		= 0x34545354,
		D3DFMT_ASTC5x5x4		= 0x34545355,
		D3DFMT_ASTC5x5x5		= 0x34545356,
		D3DFMT_ASTC6x5x5		= 0x34545357,
		D3DFMT_ASTC6x6x5		= 0x34545358,
		D3DFMT_ASTC6x6x6		= 0x34545359,

		// 2D ASTC HDR block sizes
		D3DFMT_ASTC5x4_HDR		= 0x34485342,
		D3DFMT_ASTC5x5_HDR		= 0x34485343,
		D3DFMT_ASTC6x5_HDR		= 0x34485344,
		D3DFMT_ASTC6x6_HDR		= 0x34485345,
		D3DFMT_ASTC8x5_HDR		= 0x34485346,
		D3DFMT_ASTC8x6_HDR		= 0x34485347,
		D3DFMT_ASTC8x8_HDR		= 0x34485348,
		D3DFMT_ASTC10x5_HDR		= 0x34485349,
		D3DFMT_ASTC10x6_HDR		= 0x3448534A,
		D3DFMT_ASTC10x8_HDR		= 0x3448534B,
		D3DFMT_ASTC10x10_HDR	= 0x3448534C,
		D3DFMT_ASTC12x10_HDR	= 0x3448534D,
		D3DFMT_ASTC12x12_HDR	= 0x3448534E,

		// 3D ASTC HDR block sizes
		D3DFMT_ASTC3x3x3_HDR	= 0x34485350,
		D3DFMT_ASTC4x3x3_HDR	= 0x34485351,
		D3DFMT_ASTC4x4x3_HDR	= 0x34485352,
		D3DFMT_ASTC4x4x4_HDR	= 0x34485353,
		D3DFMT_ASTC5x4x4_HDR	= 0x34485354,
		D3DFMT_ASTC5x5x4_HDR	= 0x34485355,
		D3DFMT_ASTC5x5x5_HDR	= 0x34485356,
		D3DFMT_ASTC6x5x5_HDR	= 0x34485357,
		D3DFMT_ASTC6x6x5_HDR	= 0x34485358,
		D3DFMT_ASTC6x6x6_HDR	= 0x34485359,
...
namespace ImageLoader
{
	...
	inline bool IsASTC( ImageFormat fmt )
	{
		return ( fmt == IMAGE_FORMAT_ASTC4x4 ) || ( fmt == IMAGE_FORMAT_ASTC4x4_HDR ) ||
			   ( fmt >= IMAGE_FORMAT_ASTC5x4 && fmt <= IMAGE_FORMAT_ASTC12x12 ) ||
			   ( fmt >= IMAGE_FORMAT_ASTC3x3x3 && fmt <= IMAGE_FORMAT_ASTC6x6x6 ) ||
			   ( fmt >= IMAGE_FORMAT_ASTC5x4_HDR && fmt <= IMAGE_FORMAT_ASTC12x12_HDR ) ||
			   ( fmt >= IMAGE_FORMAT_ASTC3x3x3_HDR && fmt <= IMAGE_FORMAT_ASTC6x6x6_HDR );
	}
